...
const ExamCard = (props) => {
  ...
  return (
    <div className="flex  mx-auto">
      <div className="flex flex-wrap sm:justify-center gap-5  md:justify-center lg:justify-start items-center mx-auto m-4">
        {exams &&
          exams.map((item, key) => (
            <div
              className="shadow-slate-200 shadow-lg bg-white border border-gray-300 rounded-xl bg-smoke p-4 flex  flex-col h-[290px] w-[350px]  "
              key={key}
            >
              <div className="flex items-center justify-between ">
                ...
                <div
                  className="text-2xl flex p-2  text-[#246bfd] cursor-pointer"
              ...
              <div className="mx-auto">
                <div className="flex flex-col items-start justify-start ml-[-60px] ">
                  ...
                  <div className="flex  mt-3 hover:cursor-pointer hover:scale-105">
                    <Link to="/exam" className="text-[#246bfd]  ml-3 flex justify-center items-center">
